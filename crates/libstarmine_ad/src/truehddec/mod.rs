...
pub use decoder::{ObjectPcmDecoder, ObjectPcmFrame, ObjectPcmPushResult, TrueHdError};
...
pub(crate) mod process {
    ...
    pub const EXAMPLE_DATA: &[u8] = &[
        0x01, 0x10, 0x00, 0x01, 0x00, 0x23, 0x00, 0x45, 0x00, 0x16, 0x00, 0x19, 0x00, 0x11, 0x80,
        0x00, 0xF0, 0x2A, 0xFF, 0xAC, 0xF8, 0x72, 0x6F, 0xBA, 0x00, 0x00, 0x80, 0x01, 0xB7, 0x52,
        0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x10, 0x14, 0x03, 0x80, 0x3F, 0x1F, 0xE3, 0x07, 0xE3,
        0x00, 0x52, 0x98, 0xB0, 0x18, 0x03, 0xF0, 0xF1, 0xEA, 0x00, 0x00, 0x01, 0x10, 0x00, 0x00,
        0x02, 0x09, 0x52, 0x80, 0x00, 0x00, 0x00, 0x02, 0xB4, 0x44, 0x01, 0xE8, 0xC4, 0x40, 0x88,
        0xD1, 0xFE, 0x91, 0x00, 0x63, 0x03, 0xE9, 0x18, 0x33, 0x86, 0x20, 0x68, 0xFF, 0xCB, 0x6E,
        0xDB, 0x6D, 0xB6, 0xDB, 0x6D, 0xB7, 0x80, 0x00, 0x64, 0xF9, 0x50, 0x0A, 0x00, 0x00, 0x70,
        0x07, 0x91, 0x40, 0x48, 0x00, 0x11, 0x3D, 0xDB, 0xEF, 0xF3, 0xDE, 0xD0, 0x00, 0xD5, 0x04,
    ];
        ...
        pub fn substream_mask_by_required_presentations(
            ...
            required_presentations
                ...
                .fold(
                    0,
                    |mask, (i, &required)| {
                        if required { mask | self.masks[i] } else { mask }
                    },
                )
        }
    }
...
pub(crate) mod structs {
    pub(crate) use super::access_unit;
    pub(crate) use super::block;
    pub(crate) use super::channel;
    pub(crate) use super::evolution;
    pub(crate) use super::extra_data;
    pub(crate) use super::filter;
    pub(crate) use super::matrix;
    pub(crate) use super::oamd;
    pub(crate) use super::restart_header;
    pub(crate) use super::substream;
    pub(crate) use super::sync;
}

pub(crate) mod utils {
    pub(crate) use super::bitstream as bitstream_io;
    pub(crate) use super::crc;
    pub(crate) use super::dither;
    pub(crate) use super::errors;
    pub(crate) use super::timing;
}
